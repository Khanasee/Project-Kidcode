            ...
            <form action="addstudentdata.php" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control col-sm-12" id="data" placeholder="" name="date">
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="member" class="form-control" id="member" placeholder="" name="member" required value="<?php echo $_SESSION['tech_fullname']; ?>">
                    </div>  
                </div>
                <div align="right">
