...
<head>
  ...
  <title>รายละเอียดผลงานนักเรียน</title>
          ...
          <form>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="numstudent" disabled class="form-control col-sm-12" id="numstudent" placeholder="" name="numstudent" value="<?php echo $student;?>">
              </div>
              <div class="form-group">
