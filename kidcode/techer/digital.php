              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" styale="width: 150px;">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>xxxx</td>
                        <td>xxxxxx xxxx</td>
                        <td><a href="checkdigital.php"><button type="button" class="btn btn-outline-info">รายละเอียด</button></a></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
