        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0">
                ...
                <form action="editpassword.php?edit=<?php echo $_SESSION['tech_id']; ?>" method="post">
                  <div class="card-body">
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <form action="editupdate.php?edit=<?php echo $_SESSION['tech_id']; ?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                  <div class="form-group">
