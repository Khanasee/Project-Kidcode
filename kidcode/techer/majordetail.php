        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control col-sm-12" id="major" disabled name="major" value="<?php echo $majorname; ?>">
            </div>
            <div class="form-group">
              <label for="address">ที่อยู่</label>
              <input type="text" class="form-control col-sm-12" id="address" name="address" disabled value="<?php echo $address;?>">
            </div>
            <div class="form-group">
              <label for="provi">จังหวัด</label>
              <select name="province[]" input type="text" class="form-control col-sm-12" disabled id="provi" name="provi" ><div class="form-group">
                  <option value="<?phph echo $county; ?>" selected><?phph echo $county; ?></option>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control col-sm-12" id="tel" disabled name="tel" disabled value="<?php echo $tel;?>">
            </div>
            <div class="form-group">
              <label for="tel">ชื่อเจ้าของ</label>
              <input type="text" class="form-control col-sm-12" id="tel" disabled name="name" disabled value="<?php echo $name;?>">
            </div>
            <div class="form-group">
              <label for="exampleInputFile">รูปภาพสาขา</label>
              <div class="image">
                <img src="<?php echo $photo;?>" id="imgAvatar" height="150px" width="150px"  disabled>
              </div>
              <div class="input-group">
                <div class="custom-file" >
                  <input type="file" class="custom-file-input" id="exampleInputFile" disabled name="image" OnChange="showPreview(this)"  >
            ...
            <div class="form-group">
              ...
              <?php echo $map?>
              <input type="text" class="form-control col-sm-12" id="map" name="map"  placeholder="แผ่นที่" disabled>
            </div>
