            ...
            <form>
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="numberclass" class="form-control col-sm-0" id="numberclass" placeholder="" name="numberclass">
                </div>
                <div class="form-group">
                  <label for="nameclass">ชื่อวิชา</label>
                  <input type="nameclass" class="form-control col-sm-0" id="nameclass" placeholder="" name="nameclass">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="major" class="form-control col-sm-0" id="major" placeholder="" name="major">
                </div>
                <div class="form-group">
                    <label for="teacher">อาจารย์ผู้สอน</label>
                    <input type="teacher" class="form-control" id="teacher" placeholder="" name="teacher">
                  </div>
                  <div class="form-group">
              <label for="numtime">เวลาเรียนต่อครั้ง</label>
              <input type="text" class="form-control" id="numtime" placeholder="" name="numtime">
            </div>
            <div class="form-group">
