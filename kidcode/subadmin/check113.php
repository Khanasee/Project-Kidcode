          ...
          <div class="col-lg-6 col-9">
            <div class="form-group">
                  <select class="form-control select2" style="width: 100%;">
                    ...
                    <option>Gravit</option>
                    <option>Magic Voxel</option>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">ชื่อวิชา</h4>
                    </div>
                    <!-- /.card-header -->
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>xxxx</td>
                            <td>xxxxxx xxxx</td>
                            <td><a href="checkgravit.php"><button type="button" class="btn btn-outline-info">เช็คชื่อ</button></a></td>
                          </tr>
                          <tr>
                            <td>02</td>
                            <td>voxel</td>
                            <td>xxxx</td>
                            <td>xxxxxx xxxx</td>
                            <td><a href="checkvoxel.php"><button type="button" class="btn btn-outline-info">เช็คชื่อ</button></a></td>
                          </tr>
                          <tr>
                            <td>03</td>
                            <td>art</td>
                            <td>xxxx</td>
                            <td>xxxxxx xxxx</td>
                            <td><a href="checkdigital.php"><button type="button" class="btn btn-outline-info">เช็คชื่อ</button></a></td>
                          </tr>
                          <tr>
                            <td>04</td>
                            <td>scratch</td>
                            <td>xxxx</td>
                            <td>xxxxxx xxxx</td>
                            <td><a href="checkscratch.php"><button type="button" class="btn btn-outline-info">เช็คชื่อ</button></a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
