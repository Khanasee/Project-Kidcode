<?php
 ...
 while($row = mysqli_fetch_assoc($result)){
    ...
    $prsurname = $row['fparent'];
    $prlastname = $row['lparent'];
    $line = $row['lineid'];
    $face = $row['faceid'];
    $tel = $row['telid'];
    $email = $row['email'];
    $member = $row['usernamemem'];
    $major = $row['majorid'];
    /*$astime = $row['astime'];*/
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            <h1 class="m-0">รายละเอียดรายชื่อนักเรียน</h1><br>
        </div><!-- /.row -->
            ...
            <form action="updatestudentdata.php?edit=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control col-sm-0" id="password" placeholder="" name="password" value="<?php echo $password;?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="lastname" class="form-control col-sm-12" id="lastname" placeholder="" name="lastname" value="<?php echo $lastname;?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="parentlastname" class="form-control col-sm-12" id="parentlastname" placeholder="" name="parentlastname" value="<?php echo $prlastname;?>" >
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="custom-select form-control-border" id="exampleSelectBorder" name="major" value="<?php echo $major;?>">
                    <option></option>
                    <option>ศรีราชา</option>
                    <option>พระราม5</option>
                  </select>
                </div>
              <div class="col-xs-6">
                <div class="form-group">
                  <label>เรียนวิชา</label>
                  <select class="select2" multiple="multiple" data-placeholder="" style="width: 100%;" name="classname" value="<?php echo $user;?>">
                    <option>voxel</option>
                    <option>grivit</option>
                    <option>digital art</option>
                    <option>scratch 3</option>
                  </select>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="text" class="col-xs-6 col-form-label">เวลา</label>
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="time" placeholder="" name="astime" value="<?php echo $astime;?>" disable>
                    </div>  
                </div>
                <div class="modal-footer justify-content-between">
              <a href="detailstudent.php"><button type="sumbit" class="btn btn-outline-danger" data-dismiss="modal">กลับ</button></a>
