        ...
        <div class="row mb-3">
          <div class="col-sm-3">
            ...
            <form>
              ...
              <a class="dropdown-item" href="detailstudent.php">สาขาทั้งหมด</a>
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php while($row=mysqli_fetch_assoc($result_show)){?>
                          <tr>
                            ...
                            <td><a href="detailstu2.php?id=<?php echo $row["student_id"];?>"><button type="button" class="btn btn-outline-info">รายละเอียด</button></a></td>
                          </tr>
                          <?php }?>
                        </tbody>
                      </table>
