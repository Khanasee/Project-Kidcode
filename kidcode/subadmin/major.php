                  ...
                  <div class="card">
                    ...
                    <div class="card-body table-responsive p-0" style="height: 100%;">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row2['branch_county'];?></td>
                        <td><?php echo $row2['branch_address']; ?></td>
                        <td>
                        <a href="majordetail.php?update_id=<?php echo $row2['branch_id'];?>"><button type="button" class="btn btn-outline-info">แก้ไขสาขา</button></a>
                      </tr>
                      <?php }?>
                        </tbody>
                      </table>
