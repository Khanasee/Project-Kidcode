<?php 
  ...
  if(isset($_REQUEST['edit_sub'])){
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
      ...
      $subjectallprice = $row['subject_full_amount'];
    }
    $sel_chapter = "SELECT * FROM detail_subject WHERE subject_id = '$id'";
        ...
        <div class="card card-primary">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="cost" placeholder="" name="cost" value="<?php echo $subjectcost;?>">
                  ...
                  <div class="form-group">
                    <label for="price">ราคาทั้งคอร์ส(บาท)</label>
                    <input type="price" class="form-control" id="price" placeholder="" name="price" value="<?php echo $subjectallprice;?>">
                  </div>
                  <div class="form-group">
                    <label for="price">ราคาต่อเดือน(บาท)</label>
                ...
                <div class="card">
                  ...
                  <div class="card-body table-responsive p-0" style="height: 100%;">
                    <table class="table table-head-fixed text-nowrap">
                      ...
                      <tbody>
                      <?php while($row = mysqli_fetch_array($result_chapter, MYSQLI_ASSOC)){?>
                        <tr>
                        
                          <td><input type="text" class="form-control" id="price" placeholder="" name="num_chapter[]" value="<?php echo $row['chapter_num'];?>" disabled ></td>
                          <td><input type="text" class="form-control" id="price" placeholder="" name="chapter[]" value="<?php echo $row['chapter'];?>"></td>
