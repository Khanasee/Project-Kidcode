<?php 
    ...
    if(isset($_POST['edit_class'])){
        ...
        $sql = ("UPDATE teacher_schedule set teacher_schedule_name = '$member', teacher_schedule_starttime = '$sttime', teacher_schedule_endtime = '$endtime' WHERE 	teacher_schedule_id = '$id' ");
