...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <div class="form-group">
            ...
            <select class="custom-select form-control-border" id="exampleSelectBorder" name="member[]">
            ...
            <div class="form-group">
              ...
              <input type="nameclass" class="form-control col-sm-0" disabled id="nameclass" placeholder="" name="nameclass" value="<?php echo $row['subject_full_amount']; ?>">
            </div>
            <div class="form-group">
              <label for="nameclass">ราคาต่อเดือน(บาท)</label>
              <input type="nameclass" class="form-control col-sm-0" disabled id="nameclass" placeholder="" name="nameclass" value="<?php echo $row['subject_amount']; ?>">
            </div>
            <div class="form-group">
      ...
      <button type="submit" class="btn btn-outline-success" name="edit_class">ยืนยัน</button>
    </div>
    <?php }?>
        </form>
          </div>
