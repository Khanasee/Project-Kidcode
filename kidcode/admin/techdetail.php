<?php
  ...
  $sql1 = ("SELECT *  FROM member AS d1
            ...
            ON  d1.member_branch = d2.branch_id AND member_rank = 't' AND member_status = 'อยู่ในระบบ'");
                    ...
                    <div class="card-body table-responsive p-0" style="height: 100%;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="techdetail2.php?show_id=<?php echo $row['member_id']; ?>"><button type="button" class="btn btn-outline-info">รายละเอียดอาจารย์</button></a>
