<?php 
        ...
        if (isset($_POST['edit_id'])) {
                ...
                $map = $_POST['map'];
                foreach($_POST['province'] as $provi){
                ...
                $sql = ("UPDATE branch set branch_name = '$major', branch_address = '$address', branch_map = '$map', branch_photo = '$photo', branch_county= '$provi' WHERE branch_id = '$id'");
                $result = mysqli_query($conn, $sql);
