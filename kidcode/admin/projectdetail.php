<?php
  ...
  if(isset($_GET['detail_id'])){
    ...
    $r = 1;
    $sql4 = "SELECT * FROM class_schedule INNER JOIN portfolio ON portfolio_class = class_schedule_id WHERE class_schedule_student = '$student' AND class_schedule_subject = '$subject'";
