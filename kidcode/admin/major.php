<?php
  require('../condb.php');
  $show = ("SELECT * FROM branch WHERE branch_show = 's'");
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="col-sm-2">
            ...
            <button type="button" class="btn btn-outline-success " data-toggle="modal" data-target="#modal-default"><i class="nav-icon fas fa-plus"> เพิ่มสาขา</i></button>
              </ol>
            </div>
        </div><!-- /.row -->
                  ...
                  <div class="card">
                    ...
                    <div class="card-body table-responsive p-0" style="height: 100%;">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['branch_county'];?></td>
                        <td><?php echo $row['branch_address']; ?></td>
                        <td>
                        <a href="majorsubadmin.php?add_subid=<?php echo $row['branch_id'];?>"><button type="button" class="btn btn-outline-success">เพิ่มเจ้าของสาขา</button></a>
                        <a href="majordetail.php?update_id=<?php echo $row['branch_id'];?>"><button type="button" class="btn btn-outline-info">รายละเอียดสาขา</button></a>
                        <a href="deletemajor.php?del=<?php echo $row['branch_id']; ?>" onclick="return confirm('ต้องการลบข้อมูลสาขาไหม')" class="btn btn-outline-danger">ลบข้อมูลสาขา</a></td>
                      </tr>
                      <?php } ?>
                        </tbody>
                      </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-default">
      ...
      <div class="modal-body">
        <form action="addmajor.php" method="POST" enctype="multipart/form-data">
          <div class="card-body">
            <div class="form-group">
              <label for="idmajor">รหัสสาขา</label>
              <input type="text" class="form-control col-sm-12" id="idmajor" name="idmajor">
            </div>
            <div class="form-group">
              <label for="major">สาขา</label>
              <input type="text" class="form-control col-sm-12" id="major" name="major">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control col-sm-12" id="map" name="map">
            </div>
