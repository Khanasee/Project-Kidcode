<?php
  ...
  if (isset($_REQUEST['update_id'])) {
    ...
    $check = "SELECT * FROM branch WHERE branch_id = '$realid' AND branch_onwer != ''";
    $result_check = mysqli_query($conn, $check);
    $nrow = mysqli_num_rows($result_check);

    if($nrow == 1){
    $show = ("SELECT * FROM branch INNER JOIN member ON branch_onwer = member_id  WHERE branch_id = '$realid'");
  ...
  if($nrow == 0){
    $sel = "SELECT * FROM branch WHERE branch_id = '$realid'";
