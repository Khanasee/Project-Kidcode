...
if (isset($_GET['logout'])) {
  ...
  $result_subject = mysqli_query($conn, $select_subject);

  $select_major = ("SELECT * FROM branch WHERE branch_id != 's00'");
...
<head>
  ...
  <title>รายละเอียดของนักเรียน</title>
            ...
            <form action="updatestudentdata.php?edit=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control col-sm-12" id="data" disabled placeholder="" name="date" value="<?php echo $date;?>">
                </div>
              ...
              <div class="col-xs-6">
                <div class="form-group">
                  ...
                  <input class="form-control" disabled id="time" placeholder="<?php $sql = ("SELECT * FROM class_schedule WHERE class_schedule_student = '$id'");
                              $result = mysqli_query($conn, $sql);
                ...
                <div class="form-group row">
                    <label for="member" class="col-xs-6 col-form-label">ผู้เพิ่มข้อมูล</label>
                    <div class="col-sm-12">
                      <input type="member" class="form-control" disabled id="member" placeholder="" name="member"  value="<?php echo $_SESSION['fullname']; ?>" disable>
                    </div>  
                </div>
                <div class="form-group row">
                    <label for="text" class="col-xs-6 col-form-label">วันที่สมัคร</label>
                    <div class="col-sm-12">
                      <input type="text" class="form-control" disabled id="time" placeholder="" name="astime" value="<?php echo $sttime;?>" disable>
                    </div>  
                </div>
                <div align="right">
